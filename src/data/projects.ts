...
export const projects: Project[] = [
  ...
  },
  {
    ...
    heroImage: '/Public/Projects/point92/CP.avif',
    images: [
      '/Public/Projects/point92/CP.avif',
      '/Public/Projects/point92/A1.avif',
      '/Public/Projects/point92/A2.avif',
      '/Public/Projects/point92/A3.avif',
      '/Public/Projects/point92/A4.avif',
      '/Public/Projects/point92/A5.avif',
    ],
  ...
  },
  {
    ...
    shortDescription: '',
    fullDescription: [],
    heroImage: '/Public/Projects/BohVisitor/CP.avif',
    images: [
      '/Public/Projects/BohVisitor/CP.avif',
      '/Public/Projects/BohVisitor/A1.avif',
      '/Public/Projects/BohVisitor/A2.avif',
      '/Public/Projects/BohVisitor/A3.avif',
      '/Public/Projects/BohVisitor/A4.avif'
    ],
    client: '',
  ...
  },
  {
    ...
    shortDescription: '',
    fullDescription: [],
    heroImage: '/Public/Projects/WangsaUkay/CP.avif',
    images: [
      '/Public/Projects/WangsaUkay/A1.avif',
      '/Public/Projects/WangsaUkay/A2.avif',
      '/Public/Projects/WangsaUkay/A3.avif',
    ],
    client: 'Private Client',
    materials: ['Stone', 'Timber', 'Glass', 'Zinc'],
    area: '',
  },
  {
    ...
    shortDescription: '',
    fullDescription: [],
    heroImage: '/Public/Projects/LanternHotel/CP.avif',
    images: [
      '/Public/Projects/LanternHotel/CP.avif',
      '/Public/Projects/LanternHotel/A1.avif',
      '/Public/Projects/LanternHotel/A2.avif',
      '/Public/Projects/LanternHotel/A3.avif',
      '/Public/Projects/LanternHotel/A4.avif',
      '/Public/Projects/LanternHotel/A5.avif',
    ],
    client: 'Private Client',
    materials: ['Stone', 'Timber', 'Glass', 'Zinc'],
    area: '6,200 sq ft',
  },
  {
    ...
    shortDescription: '',
    fullDescription: [],
    heroImage: '/Public/Projects/TepianTunku/CP.avif',
    images: [
      '/Public/Projects/TepianTunku/CP.avif',
      '/Public/Projects/TepianTunku/A1.avif',
      '/Public/Projects/TepianTunku/A2.avif',
      '/Public/Projects/TepianTunku/A3.avif',
      '/Public/Projects/TepianTunku/A4.avif',
      '/Public/Projects/TepianTunku/A5.avif',
    ],
    client: 'Private Client',
    materials: ['Stone', 'Timber', 'Glass', 'Zinc'],
    area: '6,200 sq ft',
