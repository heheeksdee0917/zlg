...
// Partners along the journey data
export const journeyPartners: JourneyPartner[] = [
    { name: 'sc shekar', title: 'photographer' },
    { name: 'damien yow', title: 'entrepreneur, civil engineer' },
    { name: 'gareth richards', title: 'editor, copyrighter, public speaker' },
...
// Signature projects data (optional, for better organization)
export const signatureProjects: string[] = [
    'BOH Visitor Centre',
    'Nimes Mediateque Museum',
    'HKSB HQ Canary Wharf',
    'Singapore National Library Competition',
];